...
Tests state definitions, conditional edge logic, graph compilation,
thought streaming, pipeline node decorator, and checkpointer.
"""
...
async def test_get_checkpointer_raises_without_db_url(monkeypatch):
    ...
    # May raise due to missing SUPABASE_DB_URL or missing postgres dependency
